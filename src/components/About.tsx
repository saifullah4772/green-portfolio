  ...
  return (
    <section className="pt-12 pb-20 bg-neutral-200" id="about">
      <div className="container">
        ...
        <div
          data-aos="fade-up"
          className="overflow-hidden md:w-4/5 mx-auto p-4 flex flex-col md:flex-row shadow-xl shadow-neutral-400 justify-center items-center about-radius bg-neutral-100"
        >
          ...
          <div className="md:w-1/2 h-full p-3 sm:p-4 md:p-8 flex flex-col gap-4 justify-center items-start">
            <h2 className="text-3xl font-bold text-green-600">About me</h2>
            <p className="text-sm lg:tracking-[0.2em]">
            ...
            <a
              href="#contact"
              className="bg-green-600 p-2 sm:p-4 md:px-6 duration-300 hover:bg-green-700 shadow-md shadow-neutral-400 rounded-md text-neutral-50"
            >
              Contact Now
            </a>
          </div>
